...
// const arr = [1,2,3,4,5]
// arr.split(6)// push is used to insert an element at last index
// //console.log(arr);
...
// const electronics = ['TV', 'Radio'];
// const furniture = ['Sofa', 'Table'];
// let combinedArr = arr1.concat(arr2, electronics, furniture); // combinedArr is [1, 2, 3, 4]
...
/*-------------- Sort() -----------------*/
// const num = [34, 56, 78, 12, 24]
// num.sort()
// console.log(num);
// const set = ["yellow", "peaches", "kiwi"]
// set.sort()
// console.log(set);
...
//     }
// ]
// const totalPay = course.reduce((acc, item) => {
...
// const num = [2, 4, 5]
// const result = num.reduce((acc,currval) => acc + currval, 0)
// console.log(result);
